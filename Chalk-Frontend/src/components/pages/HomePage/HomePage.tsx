...
export function HomePage() {
  return (
    <>
      <nav className="bg-white fixed w-screen z-10 px-2 sm:px-6 lg:px-8 flex h-16 items-center justify-between">
      ...
      {/**<!-- FRONT section -->*/}
      <div className="max-w-full h-screen container md:px-6 first-section overflow-hidden">
        <div className="px-6 md:px-12 text-center lg:text-left">
          <div className="grid items-center lg:grid-cols-2 lg:gap-x-12">
            ...
            <div className="object-fill lg:mb-0">
              <img src="teacher.png" className=" rounded-lg" alt="" />
            </div>
          </div>
        </div>
      </div>
