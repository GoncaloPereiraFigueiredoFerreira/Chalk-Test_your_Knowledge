...
export const exampleTest1: Test = {
  type: "basic",
  conclusion: "",
  author: "JCR",
      ...
      exercises: [
...

        {
          ...
          props: {
            ...
            items: {
              1: { text: "Portugal", justification: "", value: false },
              2: { text: "Polo norte", justification: "", value: false },
              3: { text: "Pigs", justification: "", value: false },
              4: { text: "Setúbal", justification: "", value: false },
            },
          },
        },
        {
