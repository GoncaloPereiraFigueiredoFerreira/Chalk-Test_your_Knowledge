  ...
  return (
    <>
      <footer className="bg-gray-200">
        ...
        <div className="m-4 mb-0 border-t border-gray-100 p-4">
          <div className="sm:flex sm:justify-between">
            <p className="text-xs text-gray-500">
              &copy; 2024. Chalk: Test your knowledge. All rights reserved.
            </p>
            <div>
