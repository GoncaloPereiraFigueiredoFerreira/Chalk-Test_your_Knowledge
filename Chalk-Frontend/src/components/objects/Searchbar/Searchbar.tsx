      ...
      <form className="flex w-full justify-center">
        <div className="flex w-full max-w-lg">
          ...
          <div className="relative w-full">
            <input
              type="search"
              className="block outline-none py-2.5 px-4 rounded-r-lg w-full z-20 text-black border-l-0 border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
              placeholder="Search..."
              value={searchText}
